...
export class Department1689368256260 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`training_budget\` ADD CONSTRAINT \`FK_4aa737f7f66fc971d7e7403100f\` FOREIGN KEY (\`departmentIdId\`) REFERENCES \`department\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`training_budget\` DROP FOREIGN KEY \`FK_4aa737f7f66fc971d7e7403100f\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_aeaccdecd96b09e0676ec7e379\` ON \`department\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_08853da987ab90c666a0665e2f\` ON \`department\``,
    );
