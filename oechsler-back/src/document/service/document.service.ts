...
export class DocumentService {
    constructor(
        ...
        @Inject(forwardRef(() => DocumentClasificationService)) private documentClasificationService: DocumentClasificationService,
    ){}
    ...
    async create(data: DocumentDto){
        ...
        const documentClasification = await this.documentClasificationService.findById(data.documentClasificationId);
