...
export class LogAdjustmentVacationController {
  constructor(
    private readonly logAdjustmentVacationService: LogAdjustmentVacationService,
  ) {}

  @ApiOperation({ summary: 'Crear ajuste de vacaciones' })
  @Post()
  create(
    @Body() createLogAdjustmentVacationDto: CreateLogAdjustmentVacationDto,
    @CurrentUser() user: User,
  ) {
    return this.logAdjustmentVacationService.create(
      createLogAdjustmentVacationDto,
      user,
    );
  }
  ...
  update(
    ...
    @Body() updateLogAdjustmentVacationDto: CreateLogAdjustmentVacationDto,
  ) {
    return this.logAdjustmentVacationService.update(
      id,
      updateLogAdjustmentVacationDto,
    );
  }
