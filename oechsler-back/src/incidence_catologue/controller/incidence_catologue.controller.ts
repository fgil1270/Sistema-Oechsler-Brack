...
import {
  CreateIncidenceCatologueDto,
  UpdateIncidenceCatologueDto,
} from '../dto/create-incidence_catologue.dto';
...
export class IncidenceCatologueController {
  constructor(
    private readonly incidenceCatologueService: IncidenceCatologueService,
  ) {}
  ...
  @ApiOperation({
    summary: 'Buscar incidencia dentro del catálogo de incidencias',
  })
  @Get(':id')
  ...
  update(
    ...
    @Body() updateIncidenceCatologueDto: UpdateIncidenceCatologueDto,
  ) {
    return this.incidenceCatologueService.update(
      id,
      updateIncidenceCatologueDto,
    );
  }
