...
export class IncidenceCatologueService {
  constructor(
    @InjectRepository(IncidenceCatologue)
    private incidenceCatologueRepository: Repository<IncidenceCatologue>,
  ) {}
  ...
  async remove(id: number) {
    ...
    return await this.incidenceCatologueRepository.softRemove(
      incidenceCatologue,
    );
  }
}
