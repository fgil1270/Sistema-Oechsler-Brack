...
export class DocumentClasificationController {
  ...
  @ApiOperation({ summary: 'Acceso a la vista para cargar documentos de empleados' })
  ...
  async downloadFile(
    ...
    @Param('id') id: number
      ...
      try {
        ...
        res.set('Content-Disposition', `attachment; filename="${filePath.fileName}"`);
  ...
  @ApiOperation({ summary: 'Crear clasificacion de documentos y subir archivos' })
  @Post('upload-file')
