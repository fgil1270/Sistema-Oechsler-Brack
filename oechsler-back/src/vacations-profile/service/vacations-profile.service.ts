...
export class VacationsProfileService {
  constructor(
    @InjectRepository(VacationsProfile)
    private vacationsProfileRepository: Repository<VacationsProfile>,
  ) {}
  ...
  async create(createVacationsProfileDto: CreateVacationsProfileDto) {
    ...
    const vacationsProfile = this.vacationsProfileRepository.create(
  ...
  async update(
    id: number,
    updateVacationsProfileDto: CreateVacationsProfileDto,
  ) {
    const vacationsProfile = await this.vacationsProfileRepository.findOneBy({
      id,
    });
    this.vacationsProfileRepository.merge(
      vacationsProfile,
      updateVacationsProfileDto,
    );
