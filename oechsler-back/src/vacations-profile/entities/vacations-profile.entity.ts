...
import { EmployeeVacationProfileHistory } from '../../employees/entities/employee_vacation_profile_history.entity';
...
export class VacationsProfile {
  ...
  @OneToMany(() => EmployeeVacationProfileHistory, (post) => post.vacationProfile)
