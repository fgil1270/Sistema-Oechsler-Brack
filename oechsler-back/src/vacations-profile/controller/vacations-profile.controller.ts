...
export class VacationsProfileController {
  constructor(private readonly vacationsProfileService: VacationsProfileService) {}
  ...
  @Put(':id')
  update(@Param('id', ParseIntPipe) id: number, @Body() updateVacationsProfileDto: CreateVacationsProfileDto) {
